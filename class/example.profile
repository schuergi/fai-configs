...
Name: Debian with LDAP
Description: Debian with krb and LDAP setup for centrally managed user accounts
Short: Debian with krb and LDAP setup for centrally managed user accounts
Long: Debian with krb and LDAP setup for centrally managed user accounts
Classes: INSTALL FAIBASE DEBIAN DEMO DHCPC GRUB XORG XFCE LDAP GERMAN
